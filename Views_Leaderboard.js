app.views.leaderboard = function(spieltagId, activeTab)
{
    ...
    const leaderboardData = teilnehmerIds.map(function(spielerId)
    {
        ...
        anzuzeigendeBahnen.forEach(function(bahn)
        {
            ...
            {
                // Inkrementiere gespielte Löcher
                holesPlayed++;
